...
const OpenAlbum = ({navigation}) => {
  ...
  const onRefresh = React.useCallback(async () => {
    ...
    axios
      .get(`http://k4c104.p.ssafy.io:8001/guest/image/${deadId}/${userId}`)
      .then(res => {
  ...
  const Delete = async () => {
    axios
      .delete(`http://k4c104.p.ssafy.io:8001/guest/image/${userId}/${IdCheck}`)
      .then(res => {
  ...
  const Report = async () => {
    ...
    if (FocusedPhoto.reportCheck == 0) {
      axios
        .post(`http://k4c104.p.ssafy.io:8001/guest/image/report`, data)
        .then(res => {
          FocusedPhoto.reportCheck = res.reportCheck;
          axios
            .get(
              `http://k4c104.p.ssafy.io:8001/guest/image/${deadId}/${userId}`,
            )
            .then(response => {
  ...
  const Like = async () => {
    ...
    axios
      .post(`http://k4c104.p.ssafy.io:8001/guest/image/like`, data)
      .then(res => {
  ...
  const sendImage = async () => {
    ...
    if (OpenPicture.length >= 1 && text != '') {
      ...
      axios
        .post(`http://k4c104.p.ssafy.io:8001/guest/image`, FD, {
