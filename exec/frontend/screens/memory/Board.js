...
const Board = ({navigation}) => {
  ...
  const init = async () => {
    Live
      ...
      : axios
          .get(
            `http://k4c104.p.ssafy.io:8001/guest/comment/${deadId}/${userId}`,
          )
          .then(res => {
            {
              res.data.data == null
  ...
  const Delete = async () => {
    axios
      .delete(
        `http://k4c104.p.ssafy.io:8001/guest/comment/${Value.userId}/${Value.guestCommentId}`,
      )
      .then(res => {
        init();
        modalTogle();
  ...
  const EditGo = async () => {
    ...
    if (EditData.contents == '') {
      ...
      axios
        .put(`http://k4c104.p.ssafy.io:8001/guest/comment`, EditData)
        .then(res => {
  ...
  const Report = async reportedComment => {
    ...
    if (reportedComment.reportCheck == 0) {
      axios
        .post(`http://k4c104.p.ssafy.io:8001/guest/comment/report`, data)
        .then(res => {
  ...
  const Like = async (likedComment, index) => {
    ...
    axios
      .post(`http://k4c104.p.ssafy.io:8001/guest/comment/like`, data)
      .then(res => {
        setCommentList(
  ...
  const sendComment = async () => {
    ...
    !EditOpen
      ? axios
          .post(`http://k4c104.p.ssafy.io:8001/guest/comment/`, regist_comment)
          .then(res => {
            setModalOpen(false);
            setText('');
            init();
